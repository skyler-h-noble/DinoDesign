            ...
            <Tabs defaultValue={0} variant="standard" color="primary">
              ...
              <TabPanel value={0}>
                <Box sx={{ p: 3 }}>
                  ...
                  {/* Label Position */}
                  <Box sx={{ mt: 3 }}>
                    <EyebrowSmall style={{ color: 'var(--Text-Quiet)', display: 'block', marginBottom: 8 }}>LABEL POSITION</EyebrowSmall>
                    <Stack direction="row" spacing={1}>
                      {[
                        { value: 'end',    label: 'End' },
                ...
                <Box sx={{ p: 3 }}>
                  <Stack spacing={3}>
                    ...
                    <Box sx={{ p: 3, backgroundColor: 'var(--Background)', borderRadius: 'var(--Style-Border-Radius)', border: '1px solid var(--Border)' }}>
                      ...
                      <Stack spacing={0}>
                        {[
                          { label: 'Group',         value: '<fieldset> with <legend> for group label' },
                          { label: 'Role',          value: 'role="radiogroup" on the group, native <input type="radio">' },
                          { label: 'Selection',     value: 'aria-checked managed by native radio input' },
                          ...
                          { label: 'Keyboard',      value: 'Arrow keys move between options. Space selects.' },
