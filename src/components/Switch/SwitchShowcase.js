                ...
                <Box sx={{ p: 3 }}>
                  ...
                  <Box sx={{ mt: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box>
                      ...
                      <Caption style={{ color: 'var(--Text-Quiet)', display: 'block' }}>Text label next to switch</Caption>
                    </Box>
                ...
                <Box sx={{ p: 3 }}>
                  <Stack spacing={3}>
                    ...
                    <Box sx={{ p: 3, backgroundColor: 'var(--Background)', borderRadius: 'var(--Style-Border-Radius)', border: '1px solid var(--Border)' }}>
                      ...
                      <Stack spacing={0}>
                        {[
                          { label: 'Role',     value: 'role="switch" (native checkbox with switch behavior)' },
                          { label: 'State',    value: 'aria-checked="true|false"' },
                          { label: 'Label',    value: 'FormControlLabel associates label. Without label, provide aria-label.' },
                          { label: 'Focus',    value: 'outline: 2px solid var(--Focus-Visible); outline-offset: 2px on thumb' },
                          { label: 'Hover',    value: 'Thumb shadow elevates to Effect-Level-2. No color change.' },
                          { label: 'Keyboard', value: 'Space toggles. Tab focuses.' },
                          { label: 'Disabled', value: 'HTML disabled. opacity: 0.6, pointer-events: none.' },
                        ].map(({ label, value }) => (
